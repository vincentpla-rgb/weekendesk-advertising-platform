...
const SUPPORTS: readonly SupportDefinition[] = [
  ...
  { id: 'ON-01', name: 'Marketing Block', channel: 'ONSITE', unit: 'WEEK',
    ...
    isMediaBuy: false, minMonthlyFeeCents: null, requiresAvailabilityCheck: true },
  ...
  { id: 'ON-04', name: 'Landing page dedicada', channel: 'ONSITE', unit: 'CAMPAIGN',
    ...
    isMediaBuy: false, minMonthlyFeeCents: null, requiresAvailabilityCheck: false },
  ...
  { id: 'ADS-01', name: 'Campaña Meta patrocinada', channel: 'SOCIAL_ADS', unit: 'MONTH',
    ...
    isMediaBuy: true, minMonthlyFeeCents: 120_000, requiresAvailabilityCheck: true },
  { id: 'ADS-02', name: 'Google Performance Max', channel: 'DISPLAY_SEA', unit: 'MONTH',
    ...
    isMediaBuy: true, minMonthlyFeeCents: 150_000, requiresAvailabilityCheck: false },
  { id: 'ADS-03', name: 'Display ads', channel: 'DISPLAY_SEA', unit: 'MONTH',
    ...
    isMediaBuy: true, minMonthlyFeeCents: null, requiresAvailabilityCheck: false },
